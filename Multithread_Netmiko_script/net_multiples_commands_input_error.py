...
commands_send = get_commands("Enter Commands, press enter when finished: ")
...
def deviceconnector(i,q):
    ...
    while True:
       ...
       # for command in commands:
        ...
        with print_lock:
            print("{}: Printing output...".format(i) + ip)
            pprint(output)
